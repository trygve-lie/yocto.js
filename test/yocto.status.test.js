...
buster.testCase("yocto.js Test - Status", {
    ...
    setUp: function(done) {
        ...
        this.db = yocto.db({uuid:'id', timestamp:'timestamp'});
    ...
    "status().highest - in callback highest timestamp should be 1100": function(done) {
        this.db.status(function(obj){
            buster.assert.equals(obj.highest, 1100);
            done();
        })
    }
